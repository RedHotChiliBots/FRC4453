...
public class TestTilt_GetShooterHeight {
	...
	public TestTilt_GetShooterHeight(double tilt, double expected) {
		this.tilt  = tilt;
	...
	@Test 
	public void test_GetShooterHeight() {	
		Tilt.setTestTiltAngle(tilt);
		
		double output = Tilt.getShooterHeight(true);
		System.out.println("getShooterHeight:  Tilt: "+tilt+"   Expected: "+expected+"   Actual: "+output);
