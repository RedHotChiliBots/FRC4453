...
/**
 * Autonomous Command
 * Used to drive forward to a specific distance
 * and shoot the ball at a specified angle and strength.
 * 
 * @author Developer
 */
public class AutoShootDistance extends CommandGroup {
	
	public AutoShootDistance() {
        // Add Commands here:
		...
		addParallel(new DriveToDistance(true));		
